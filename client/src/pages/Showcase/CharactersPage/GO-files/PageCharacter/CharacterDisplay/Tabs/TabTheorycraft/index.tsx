...
import { initCharTC } from "genshin-optimizer/db";
import { useDBMeta, useDatabase } from "genshin-optimizer/db-ui";
import { StatIcon } from "genshin-optimizer/svgicons";
import { BuildAlert, initialBuildStatus } from "genshin-optimizer/ui";
import { getSubstatValue } from "genshin-optimizer/util";
...
export default function TabTheorycraft() {
  ...
  const resetData = useCallback(() => {
    setCharTC(
      initCharTC(defaultInitialWeaponKey(characterSheet.weaponTypeKey))
    );
