...
/**
 * @deprecated use `StyledInputBase` in `genshin-optimizer/ui`
 */
...
/**
 * @deprecated use `CustomNumberInputButtonGroupWrapper` in `genshin-optimizer/ui`
 */
...
/**
 * @deprecated use `CustomNumberInput` in `genshin-optimizer/ui`
 */
